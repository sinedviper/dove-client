...
export const FormConfirmation = ({ className, ...props }: FormConfirmationProps): JSX.Element => {
  ...
  const [mutateFunction, { loading: loadingMutation }] = useMutation(confirmationAccount, {
    fetchPolicy: 'network-only',
  })
    ...
    <>
      <section className={cn(className, styles.form)} {...props}>
        ...
        <div className={styles.login}>
          <Input text={code} setText={setCode} placeholderName={'Code'} error={errorCode} />
