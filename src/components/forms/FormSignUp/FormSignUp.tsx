...
export const FormSignUp = ({ className, ...props }: FormSignUpProps): JSX.Element => {
    ...
    <section className={cn(className, styles.form)} {...props}>
      ...
      <div className={styles.login}>
        <Input
          ...
          error={errorName}
          notification={true}
          notificationText={'Name must be between 1 and 40 characters and have a letters'}
        />
        <Input
          text={surname}
          setText={setSurname}
          ...
          error={errorSurname}
          notification={true}
          notificationText={'Surname must be between 1 and 40 characters and have a letters'}
        />
        <Input
          text={username}
          setText={setUsername}
        ...
        <button onClick={onSubmit} className={styles.button}>
          <p>SIGN UP</p>
          <span className={styles.loading}>{loadingMutation ? <LoadingIcon /> : ''}</span>
        </button>
