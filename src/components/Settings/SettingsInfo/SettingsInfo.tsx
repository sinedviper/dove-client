    ...
    <div className={className} {...props}>
      ...
      >
          ...
          >
            {imageUser?.length === 1 ? (
              <div key={imageUser[0].id} className={styles.userImageWrapper}>
                ...
                {buttonPhoto && !profile && (
                  <button
                    onClick={() => handleRemovePhoto(imageUser[0].id, imageUser[0].file)}
              ...
              <Carousel
                ...
                defaultControlsConfig={{
                  ...
                  prevButtonText: <BackPhotoIcon className={styles.iconButton} />,
                  prevButtonStyle: {
                    background: 'none',
                    transition: 'var(--transition)',
                  },
        ...
        {user && (
          <div className={styles.photoFIO}>
            ...
            <p className={styles.userOnline}>{formateDateOnline(new Date(user.online))}</p>
          </div>
        )}
        {!profile && (
          <div className={styles.uploadWrapper}>
            <button className={styles.uploadPhoto} tabIndex={-1}>
              <label className={styles.iconPhotoWrapper} htmlFor='loadphoto' tabIndex={tabIndex}>
                <PhotoIcon />
              </label>
              <input
                name='image'
      ...
      <div className={styles.infoLast}>
        <div
          ...
          onKeyDown={(e) => e.key === 'Enter' && handleCopy(String(user?.email))}
          tabIndex={tabIndex}
        >
        ...
        <div
          ...
          onKeyDown={(e) => e.key === 'Enter' && handleCopy(String(user?.username))}
          tabIndex={tabIndex}
        >
        ...
        {user && user.bio && (
          <div
            ...
            onKeyDown={(e) => e.key === 'Enter' && handleCopy(String(user.bio))}
            tabIndex={tabIndex}
          >
